...
int main() {
    std::vector<std::string> fileNames = {
	            "flattened_automobile_automobile_1.txt",
        "flattened_bird_bird_1.txt",
        "flattened_deer_deer_1.txt",
        "flattened_deer_deer_2.txt",
        "flattened_dog_dog_1.txt",
        "flattened_horse_horse_1.txt",
        "flattened_ship_ship_1.txt",
        "flattened_ship_ship_2.txt",
        "flattened_truck_truck_1.txt"
    };
